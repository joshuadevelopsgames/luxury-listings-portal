...
const CRMPage = () => {
  ...
  // Check permissions
  const canManageCRM = hasPermission(CAPABILITIES.MANAGE_CRM);
  const canManageLeads = hasPermission(CAPABILITIES.MANAGE_LEADS);
  const canViewLeads = hasPermission(CAPABILITIES.VIEW_LEADS);
  const canDeleteClients = hasPermission(CAPABILITIES.DELETE_CLIENTS);
