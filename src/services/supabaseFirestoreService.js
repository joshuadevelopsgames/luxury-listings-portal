  ...
  async updateApprovedUser(email, updates) {
    try {
      ...
      const payload = clean({
        ...
        ...(safe.avatar_url !== undefined ? { avatar_url: safe.avatar_url } : {}),
  ...
  async addClient(clientData) {
    try {
      ...
      const { data, error } = await supabase.from('clients').insert([clean({
        ...
        logo_url: clientData.logo || clientData.logo_url || null,
  ...
  async updateClient(clientId, clientData) {
    try {
      const payload = clean({
        ...
        ...(clientData.logo !== undefined ? { logo: clientData.logo, logo_url: clientData.logo } : {}),
