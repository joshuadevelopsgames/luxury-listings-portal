...
import { Plus, Search, Clock, Star, MoreHorizontal } from 'lucide-react';

/**
 * Demo Tasks Page - Apple-style task management
 */
const DemoTasks = () => {
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  <span className={`px-2.5 py-1 rounded-md text-[11px] font-semibold text-white bg-gradient-to-r ${categoryColors[task.category]}`}>
                    {task.category}
                  </span>
