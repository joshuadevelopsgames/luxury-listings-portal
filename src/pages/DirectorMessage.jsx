  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-6">
        {/* Main Message Card */}
        <Card className="border-indigo-200 bg-brand-soft dark:bg-indigo-950/20 dark:border-brand">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="bg-white dark:bg-gray-900 p-4 rounded-lg border border-indigo-200 dark:border-brand">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Hold weekly meetings to review progress and address blockers</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Prepare comprehensive performance reports for stakeholders</p>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Invest in team growth through feedback, training, and mentorship</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Proactively identify opportunities to exceed client expectations</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 border dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                <BarChart3 className="h-8 w-8 text-brand mx-auto mb-2" />
