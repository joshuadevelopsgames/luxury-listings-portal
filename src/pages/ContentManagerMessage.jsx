  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-6">
        {/* Main Message Card */}
        <Card className="border-blue-200 bg-brand-soft">
          <CardHeader>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning">Review pending tasks and content approvals every morning</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning">Maintain clear communication with all team members</p>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning">Track engagement rates and content performance weekly</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning">Keep detailed records of content strategies and results</p>
                  </div>
                </div>
              </div>
            </div>
