          ...
          for (const email of newEmails) {
            if (email && email !== currentEmail && !prevEmails.has(email) && sharedEmails.has(email)) {
              ...
              supabaseService.createNotification({
                ...
                link: `/workspaces?id=${canvasRowId}&block=${blockIdForLink}`,
                read: false,
              }).catch(() => {});
            }
          }
  ...
  const handleShareInvite = async () => {
    ...
    try {
      ...
      await supabaseService.createNotification({
        ...
        link: `/workspaces?id=${canvasRowId}`,
        read: false,
      });
          ...
          <div className="bg-card border border-border rounded-xl shadow-lg p-7 max-w-md w-full max-h-[80vh] flex flex-col">
            ...
            <div className="flex gap-2 mb-4">
              ...
              <button
                ...
                className="px-3.5 py-2 rounded-md bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-sm disabled:opacity-50"
              >
                Add
              </button>
            </div>
          ...
          <div className="bg-card border border-border rounded-xl shadow-lg p-7 max-w-md w-full">
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <button
                type="button"
                onClick={insertLink}
                className="px-3.5 py-2 rounded-md bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-sm"
              >
                Insert
              </button>
            </div>
