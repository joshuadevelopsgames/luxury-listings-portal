  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-6">
        {/* Main Message Card */}
        <Card className="border-orange-200 bg-warning-soft dark:bg-orange-950/20 dark:border-warning">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="bg-white dark:bg-gray-900 p-4 rounded-lg border border-orange-200 dark:border-warning">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-brand dark:text-brand">Focus on understanding client needs before presenting solutions</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Heart className="h-5 w-5 text-brand mt-0.5" />
                  <div>
                    <h4 className="font-semibold text-blue-900 dark:text-blue-400">Value Selling</h4>
                    <p className="text-sm text-brand dark:text-brand">Emphasize ROI and results over features and pricing</p>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-brand dark:text-brand">Maintain consistent follow-up without being pushy</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-brand dark:text-brand">Position pricing around value delivered, not cost</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Respond to new leads within 1 hour during business hours</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Update deal stages and notes after every client interaction</p>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Ensure smooth transition when onboarding new clients to the team</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Review pipeline weekly and identify stuck deals</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="dark:bg-gray-900 dark:border-gray-800">
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="text-center p-4 border dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                <DollarSign className="h-8 w-8 text-brand mx-auto mb-2" />
