      ...
      <div className="space-y-6">
        ...
        <Card className="border-green-200 bg-positive-soft dark:bg-green-950/20 dark:border-positive">
          ...
          <CardContent className="space-y-4">
            <div className="bg-white dark:bg-gray-900 p-4 rounded-lg border border-green-200 dark:border-positive">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Process all leave requests within 24-48 hours</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Keep all employee information strictly confidential</p>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Keep leave balances accurate and up-to-date</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Approach all situations with understanding and fairness</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="border-blue-200 bg-brand-soft dark:bg-blue-950/20 dark:border-brand">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <UserCheck className="h-5 w-5 text-brand mt-0.5" />
                  <div>
                    <h4 className="font-semibold text-blue-900 dark:text-blue-400">Approval Criteria</h4>
                    <p className="text-sm text-brand dark:text-brand">Check balance availability, team coverage, and advance notice</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-brand dark:text-brand">Be cautious approving leave during busy periods or project deadlines</p>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-brand dark:text-brand">Request documentation for extended sick leave as per policy</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Users className="h-5 w-5 text-brand mt-0.5" />
                  <div>
                    <h4 className="font-semibold text-blue-900 dark:text-blue-400">Team Impact</h4>
                    <p className="text-sm text-brand dark:text-brand">Consider impact on team workload and client deliverables</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="dark:bg-gray-900 dark:border-gray-800">
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="text-center p-4 border dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                <Users className="h-8 w-8 text-positive mx-auto mb-2" />
              ...
              <div className="text-center p-4 border dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                <FileText className="h-8 w-8 text-brand mx-auto mb-2" />
