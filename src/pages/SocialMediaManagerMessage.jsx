  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-6">
        {/* Main Message Card */}
        <Card className="border-purple-200 bg-brand-soft dark:bg-purple-950/20 dark:border-brand">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="bg-white dark:bg-gray-900 p-4 rounded-lg border border-purple-200 dark:border-brand">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Reply to all comments and DMs within 2-4 hours during business hours</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Instagram className="h-5 w-5 text-warning mt-0.5" />
                  <div>
                    <h4 className="font-semibold text-amber-900 dark:text-amber-400">Content Consistency</h4>
                    <p className="text-sm text-warning dark:text-warning">Maintain consistent posting schedule - never skip scheduled posts</p>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Always maintain professional, luxury tone - no slang or casual language</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warning dark:text-warning">Stay updated on platform algorithm changes and trending formats</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="border-green-200 bg-positive-soft dark:bg-green-950/20 dark:border-positive">
          <CardHeader>
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="flex items-start gap-3">
                <MessageCircle className="h-5 w-5 text-positive mt-0.5" />
                <div>
                  <h4 className="font-semibold text-green-900 dark:text-green-400">Comments</h4>
                  <p className="text-sm text-positive dark:text-positive">Reply with personalized, thoughtful responses - not generic replies</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Share2 className="h-5 w-5 text-positive mt-0.5" />
                <div>
                  <h4 className="font-semibold text-green-900 dark:text-green-400">Shares</h4>
                  <p className="text-sm text-positive dark:text-positive">Create shareable content that adds value to your audience</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Users className="h-5 w-5 text-positive mt-0.5" />
                <div>
                  <h4 className="font-semibold text-green-900 dark:text-green-400">Community</h4>
                  <p className="text-sm text-positive dark:text-positive">Engage with related accounts to build network and visibility</p>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 border dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                <Calendar className="h-8 w-8 text-brand mx-auto mb-2" />
              ...
              <div className="text-center p-4 border dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                <BarChart3 className="h-8 w-8 text-positive mx-auto mb-2" />
