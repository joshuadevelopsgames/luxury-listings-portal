// ============================================================
// Compact lucide-style icon set. <Icon name="eye" className="..." />
// Ported from the design handoff prototype (was a window.* global).
// ============================================================
import React from 'react';

export const ICON_PATHS = {
  eye: '<path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/>',
  eyeOff: '<path d="M9.9 4.24A9.1 9.1 0 0 1 12 4c6.5 0 10 7 10 7a13.2 13.2 0 0 1-2.16 2.92"/><path d="M6.6 6.6A13.3 13.3 0 0 0 2 11s3.5 7 10 7a9 9 0 0 0 4.4-1.1"/><path d="M14.1 14.1a3 3 0 0 1-4.2-4.2"/><line x1="2" y1="2" x2="22" y2="22"/>',
  ...
  phone: '<rect x="6" y="2" width="12" height="20" rx="2.6" ry="2.6"/><line x1="11" y1="18.5" x2="13" y2="18.5"/>',
};

export function Icon({ name, className = '', strokeWidth = 2, fill = 'none', style }) {
