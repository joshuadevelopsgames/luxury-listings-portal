...
export const REPORT_DATA = {
  metrics: {
    ...
    gender: { men: 52.0, women: 48.0 },
    growth: { overall: -37, follows: 6724, unfollows: 6761 },
    activeTimes: [
...
export const BLOCK_LIBRARY = [
  ...
  { type: 'metrics', name: 'Key Metrics', desc: 'Views, followers, reach, visits', icon: 'zap', span: 'full',
    defaults: { title: 'Performance at a Glance', metrics: [
      { icon: 'eye', label: 'Total Views', value: '16,493', sub: '52.9% from followers', trend: 'none' },
      { icon: 'users', label: 'Followers', value: '6,649', sub: '-37 (-0.6%)', trend: 'down' },
      { icon: 'pointer', label: 'Profile Visits', value: '907', sub: '+147.1%', trend: 'up' },
      { icon: 'globe', label: 'Accounts Reached', value: '858', sub: '-34.3%', trend: 'down' },
    ] } },
  { type: 'highlights', name: 'Written Highlights', desc: 'Manager notes & takeaways', icon: 'message', span: 'full',
    defaults: { title: 'Report Highlights', body: 'Strong month for profile visits with +147.1% growth! Posts continue to drive the majority of views (85%). Top audience is 25–34 year olds (42.6%) located primarily in Calgary. Recommend focusing on content during peak activity hours (9am–6pm) to maximize engagement.' } },
